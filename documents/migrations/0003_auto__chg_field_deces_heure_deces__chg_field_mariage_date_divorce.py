...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deces.heure_deces'
        db.alter_column(u'documents_deces', 'heure_deces', self.gf('django.db.models.fields.TimeField')(max_length=250, null=True))

        # Changing field 'Mariage.date_divorce'
        db.alter_column(u'documents_mariage', 'date_divorce', self.gf('django.db.models.fields.DateField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'Deces.heure_deces'
        db.alter_column(u'documents_deces', 'heure_deces', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2018, 8, 20, 0, 0), max_length=250))

        # Changing field 'Mariage.date_divorce'
        db.alter_column(u'documents_mariage', 'date_divorce', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2018, 8, 20, 0, 0), max_length=250))
