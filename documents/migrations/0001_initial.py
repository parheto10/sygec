...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'documents_jugement', (
            ...
            ('date_naiss_pere', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('date_naiss_mere', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
