...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deces.sexe'
        db.add_column(u'documents_deces', 'sexe',
                      self.gf('django.db.models.fields.CharField')(default=u'M', max_length=150),
                      keep_default=False)


        # Changing field 'Deces.cause_deces'
        db.alter_column(u'documents_deces', 'cause_deces', self.gf('django.db.models.fields.TextField')(max_length=250))

        # Changing field 'Mariage.heure_mariage'
        db.alter_column(u'documents_mariage', 'heure_mariage', self.gf('django.db.models.fields.TimeField')())

    def backwards(self, orm):
        # Deleting field 'Deces.sexe'
        db.delete_column(u'documents_deces', 'sexe')


        # Changing field 'Deces.cause_deces'
        db.alter_column(u'documents_deces', 'cause_deces', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Mariage.heure_mariage'
        db.alter_column(u'documents_mariage', 'heure_mariage', self.gf('django.db.models.fields.DateField')())
